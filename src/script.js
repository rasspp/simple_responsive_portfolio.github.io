...
(function (modules, entry, mainEntry, parcelRequireName, globalName) {
  ...
  */ var OVERLAY_ID = "__parcel__error__overlay__";
  ...
  <a href="/__parcel_launch_editor?file=${encodeURIComponent(
     frame.location
  )}" style="text-decoration: underline; color: #888" onclick="fetch(this.href); return false">${frame.location}</a>
  ${frame.code}`;
                       }, "")
                     : diagnostic.stack;
                  errorHTML += `
      ...
      "72kAb": [
         ...
         { "vanilla-tilt": "jiWzO", "@parcel/transformer-js/src/esmodule-helpers.js": "gkKU3" },
      ],
      jiWzO: [
         function (require, module, exports) {
            "use strict";
